    ...
    <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-4 md:px-8 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-2 md:gap-4 min-w-0">
        <button 
          ...
          className="lg:hidden p-2 rounded-xl hover:bg-gray-50 text-gray-700 cursor-pointer shrink-0"
        >
          <Menu size={20} />
        </button>
        <div className="min-w-0">
          <h2 className="text-base md:text-xl font-bold text-gray-900 capitalize truncate">{viewTitle?.replace('-', ' ')}</h2>
          <p className="text-[10px] md:text-xs text-gray-500 truncate">Levlox Tech CRM</p>
        </div>
      </div>
